...
const ResumenMensual = () => {
    ...
    const normalizar = s => (s || '').normalize('NFD').replace(/[0-\u036f]/g, '').toLowerCase().trim();
                ...
                <table className="tabla">
                    <thead>
                        <tr>
                            ...
                            <th className="col-divisor-header" style={{width: 2, padding: 0}}></th>
